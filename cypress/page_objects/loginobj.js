        ...
        if (currentToken != null) { // Logged In User
            ...
            cy.request(option).then((elm) => {
                ...
                if (elm.status == 401) {
                    ...
                    cy.get('#email').type('testliven@mailinator.com')
            ...
            cy.log("ma baira xu hai ")
                ...
                .get('#email').type('testliven@mailinator.com')
